...
https://github.com/gpleiss/temperature_scaling/blob/a474b23f6958be9629b70341a85f5b53fcfb0ec8/temperature_scaling.py
'''
...
def calibrate(model, data_loader, opt, logger):
    model_with_temp = ModelWithTemperature(model=model)
    model_with_temp.set_temperature(valid_loader=data_loader)
